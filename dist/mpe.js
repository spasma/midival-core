...
__export(mpe_exports, {
  ...
  MPEInputZone: () => MPEInputZone,
  MPEMidivalInput: () => MPEMidivalInput,
  MPEMidivalOutput: () => MPEMidivalOutput,
  MPEOutputZone: () => MPEOutputZone
});
module.exports = __toCommonJS(mpe_exports);

// src/mpe/input/MPEMidivalInput.ts
var import_omnibus2 = require("@hypersphere/omnibus");

// src/mpe/input/MPEInputZone.ts
var import_omnibus = require("@hypersphere/omnibus");
var MPEInputZone = class {
  ...
  #pressure = 0;
  buildBus() {
    return import_omnibus.Omnibus.builder().register("noteOn", (0, import_omnibus.args)()).register("noteOff", (0, import_omnibus.args)()).register("masterPitchBend", (0, import_omnibus.args)()).register("memberPitchBend", (0, import_omnibus.args)()).register("masterTimbre", (0, import_omnibus.args)()).register("memberTimbre", (0, import_omnibus.args)()).register("masterPressure", (0, import_omnibus.args)()).register("memberPressure", (0, import_omnibus.args)()).build();
  }
  bindEvents() {
...
var MPEMidivalInput = class {
  ...
  #upperZone;
  buildBus() {
    return import_omnibus2.Omnibus.builder().register("lowerZoneUpdate", (0, import_omnibus2.args)()).register("upperZoneUpdate", (0, import_omnibus2.args)()).build();
  }
...
var import_omnibus3 = require("@hypersphere/omnibus");
var buildInputBus = () => {
  return import_omnibus3.Omnibus.builder().register("pithchBend", (0, import_omnibus3.args)()).register("sysex", (0, import_omnibus3.args)()).register("channelPressure", (0, import_omnibus3.args)()).register("noteOn", (0, import_omnibus3.args)()).register("noteOff", (0, import_omnibus3.args)()).register("controlChange", (0, import_omnibus3.args)()).register("programChange", (0, import_omnibus3.args)()).register("polyKeyPressure", (0, import_omnibus3.args)()).register("clockPulse", (0, import_omnibus3.args)()).register("clockStart", (0, import_omnibus3.args)()).register("clockStop", (0, import_omnibus3.args)()).register("clockContinue", (0, import_omnibus3.args)()).register("registeredParameterData", (0, import_omnibus3.args)()).build();
};
...
var MIDIValInput = class _MIDIValInput {
  ...
  onBusKeyValue(event, key, value, callback) {
    return this.omnibus.on(event, (...args4) => {
      if (!args4.length) {
        return;
      }
      const obj = args4[0];
...
var import_omnibus4 = require("@hypersphere/omnibus");
var BrowserMIDIAccess = class {
  access;
  bus = new import_omnibus4.Omnibus();
...
// src/index.ts
var import_omnibus5 = require("@hypersphere/omnibus");
