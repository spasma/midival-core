...
__export(src_exports, {
  Callback: () => import_omnibus3.CallbackType,
  MIDIVal: () => MIDIVal,
  MIDIValInput: () => MIDIValInput,
  MIDIValOutput: () => MIDIValOutput,
  UnregisterCallback: () => import_omnibus3.UnregisterCallback
});
...
var buildInputBus = () => {
  return import_omnibus.Omnibus.builder().register("pithchBend", (0, import_omnibus.args)()).register("sysex", (0, import_omnibus.args)()).register("channelPressure", (0, import_omnibus.args)()).register("noteOn", (0, import_omnibus.args)()).register("noteOff", (0, import_omnibus.args)()).register("controlChange", (0, import_omnibus.args)()).register("programChange", (0, import_omnibus.args)()).register("polyKeyPressure", (0, import_omnibus.args)()).register("clockPulse", (0, import_omnibus.args)()).register("clockStart", (0, import_omnibus.args)()).register("clockStop", (0, import_omnibus.args)()).register("clockContinue", (0, import_omnibus.args)()).register("registeredParameterData", (0, import_omnibus.args)()).build();
};
...
var BrowserMIDIAccess = class {
  access;
  bus = new import_omnibus2.Omnibus();
